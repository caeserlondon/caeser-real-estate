...
export function TestimonialsSection() {
  ...
  return (
    <section id="testimonials" className="py-24 bg-neutral-900 border-y border-white/5">
      <div className="max-w-7xl mx-auto px-6">
        {/* Header */}
        <div className="text-center mb-16">
          <p className="text-gold text-xs font-bold tracking-[0.2em] uppercase mb-3">Client Stories</p>
          <h2 className="font-serif text-3xl md:text-4xl lg:text-5xl text-white leading-tight">
            WHAT MY CLIENTS SAY
          </h2>
          <p className="text-neutral-500 text-base italic font-light mt-4">
          ...
          {currentTestimonials.map((testimonial, idx) => (
            ...
            >
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h5 className="text-white text-xs font-bold tracking-[0.15em] uppercase">
                    {testimonial.name}
                  </h5>
                  <p className="text-[11px] text-neutral-500 mt-0.5">{testimonial.role}</p>
                </div>
              </div>
            </div>
          ))}
        ...
        {totalPages > 1 && (
          <div className="flex items-center justify-center gap-6 mt-12">
            ...
            <span className="text-neutral-500 text-xs tracking-widest tabular-nums">
              {page + 1} / {totalPages}
            </span>
            <button
              onClick={goForward}
